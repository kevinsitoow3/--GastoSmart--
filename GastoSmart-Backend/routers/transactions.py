...
async def create_transaction(
    ...
    """
    try:
        transaction = await transaction_ops.create_transaction(user_id, transaction_data)
        return transaction
...
async def get_transaction(
    ...
    """
    transaction = await transaction_ops.get_transaction_by_id(transaction_id, user_id)
...
async def update_transaction(
    ...
    """
    try:
        transaction = await transaction_ops.update_transaction(transaction_id, user_id, update_data)
...
async def delete_transaction(
    ...
    Raises:
        HTTPException: Si la transacción no existe
    """
    success = await transaction_ops.delete_transaction(transaction_id, user_id)
...
async def get_transaction_stats(
    ...
    """
    try:
        stats = await transaction_ops.get_transaction_stats(user_id, date_from, date_to)
        return stats
...
async def get_categories(
    ...
    """
    try:
        categories = await transaction_ops.get_categories(user_id, transaction_type)
